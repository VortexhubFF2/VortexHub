...
print("https://discord.gg/9EDSzchFpn")
toclipboard("https://discord.gg/9EDSzchFpn")
...
function LoadSettings()
    if readfile and writefile and isfile and isfolder then
        if not isfolder("Vortex Hub") then
            makefolder("Vortex Hub")
        end
        if not isfolder("Vortex Hub/Blox Fruits/") then
            makefolder("Vortex Hub/Blox Fruits/")
        end
        if not isfile("Vortex Hub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
            writefile("Vortex Hub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(_G.Settings))
        else
            local Decode = game:GetService("HttpService"):JSONDecode(readfile("Vortex Hub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"))
...
function SaveSettings()
    if readfile and writefile and isfile and isfolder then
        if not isfile("Vortex Hub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
            ...
            writefile("Vortex Hub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(Array))
        end
    else
        return warn("Status : Undetected Executor")
    end
